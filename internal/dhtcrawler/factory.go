			...
			fx.Hook{
				OnStart: func(context.Context) error {
					...
					c = crawler{
						...
						tfileWriter:                  newTFileWriter(saveTorrentsRoot, params.Config.TfileMaxTorrentsPerFile, params.Config.TfilePrefix, params.Logger.Named("dht_crawler").Named("tfile_writer")),
